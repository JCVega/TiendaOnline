...
<asp:Content ID="Content2" ContentPlaceHolderID="contentSlider" runat="server">
    ...
    <table>
        ...
        <tr>
            <td>Teléfono</td>
             <td><asp:TextBox runat="server" ID="txtTelefono" Width="300"></asp:TextBox>
                 <asp:RequiredFieldValidator runat="server" ID="rqv_telefono" ControlToValidate="txtTelefono" Display="Dynamic" ErrorMessage="campo obligatorio" ForeColor="Red"></asp:RequiredFieldValidator>
             </td>
        </tr>
        <tr>
            <td>Sexo</td>
